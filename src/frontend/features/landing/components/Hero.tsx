          ...
          <div className="lg:col-span-5 w-full max-w-md mx-auto lg:mx-0">
            <div className="bg-white rounded-2xl shadow-2xl shadow-indigo-900/10 border border-slate-100 p-8 sm:p-10 relative overflow-hidden group">
              ...
              <button
                ...
                disabled={isLoading}
                className="w-full flex cursor-pointer items-center justify-center gap-3 bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 font-semibold py-3 px-4 rounded-lg transition-all duration-200 shadow-sm hover:shadow-md mb-6 group-focus:ring-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isLoading ? (
              ...
              {error && (
                <div className="mb-4 rounded-md bg-red-50 p-2 text-center text-xs font-medium text-red-600 border border-red-100">
                  {error}
                </div>
              )}
